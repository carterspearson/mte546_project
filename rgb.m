...
%rgbImage = imread('white_face_2.png');
rgbImage = imread('flushed_face_2.png');
rgbImage = rgb2hsv(rgbImage);
[h,s,v] = imsplit(rgbImage);
% Extract color channels.
redChannel = rgbImage(:,:,1)*255; % Red channel
greenChannel = rgbImage(:,:,2)*255; % Green channel
blueChannel = rgbImage(:,:,3)*255; % Blue channel
